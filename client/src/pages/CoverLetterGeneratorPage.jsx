...
import { Loader2, Sparkles, Clipboard, Check, AlertCircle, Save, ArrowLeft } from 'lucide-react';
    ...
    <>
      ...
      <div className="container mx-auto max-w-7xl px-4 py-10">
        ...
        >
          ...
          <div>
            <h1 className="text-3xl font-bold text-primary">AI Cover Letter Generator</h1>
            <p className="mt-1 text-muted-foreground">Craft a compelling letter tailored to the job you want.</p>
          </div>
        </motion.header>
