...
//     setEditorFormData(prev => {
//       const d = cloneDeep(prev);
//       set(d, `sectionsConfig.${sectionKey}.enabled`, !get(d, `sectionsConfig.${sectionKey}.enabled`, false));
//       return d;
//     });
//   }, [setEditorFormData]);
...
import { Eye, Settings2, RefreshCw, AlertCircle } from "lucide-react";
import LoadingSpinner from '@/components/Common/LoadingSpinner/LoadingSpinner';
...
const ResumeEditorPage = () => {
    // 1. All state, context, and router hooks are now managed by this single custom hook.
    const {
        // Router & Refs
        newResumeTemplateId, existingResumeId, navigate, location,
        resumePreviewRef, nameInputRef,
        // Contexts (destructured for direct use)
    ...
    usePageSetupEffect({
      ...
      setSpacingMultiplier, setSelectedIndustry, setSelectedStylePackKey,
