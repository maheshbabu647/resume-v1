...
//     const saveOrUpdateCurrentResume = useCallback(async (formDataToSave, newResumeName, spacingMultiplier) => {
//         console.log("hey")
//         console.log(isAuthenticated, currentResumeDetail)
//         if (!isAuthenticated || !currentResumeDetail || !currentResumeDetail.templateId) {
...
//                 resume = await apiUpdateResume(currentResumeDetail._id, payload);
//                 setUserResumesList(prevList => prevList.map(res => (res._id === resume._id ? resume : res)));
//             } else {
//                 resume = await apiCreateResume(payload);
//                 setUserResumesList(prevList => [resume, ...prevList]);
//             }
