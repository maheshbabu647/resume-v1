    ...
    >
      <div className="container mx-auto px-6 text-center py-20 md:py-28">
        ...
        >
            ...
            <Button
              size="lg"
              className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-2xl transform hover:scale-105 active:scale-100 transition-all duration-200 ease-in-out px-10 py-3.5 text-lg font-semibold"
              asChild
            >
