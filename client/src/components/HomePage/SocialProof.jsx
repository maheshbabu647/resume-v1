...
//   return (
//     // Replaced gradient with the semantic `bg-background`
...
//         >
//           {/* Badge now uses semantic card and success colors */}
//           <motion.div 
...
//           >
//             {/* The green color now comes from the 'success' theme variable */}
...
//             {/* Gradient updated to use primary and accent-purple theme colors */}
...
//         {/* Logos Grid */}
//         <motion.div 
//           className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-center justify-items-center max-w-5xl mx-auto"
...
//               {/* Card now uses semantic card and border colors */}
...
//               {/* Floating Success Indicator now uses semantic success color */}
//               <motion.div 
...
//             transition={{ type: "spring", stiffness: 300 }}
//           >
//             {/* Text gradient now uses primary theme color */}
...
//             transition={{ type: "spring", stiffness: 300 }}
//           >
//             {/* Text gradient now uses success theme color */}
...
//             transition={{ type: "spring", stiffness: 300 }}
//           >
//             {/* Text gradient now uses accent theme colors */}
