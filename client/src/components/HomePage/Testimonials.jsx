...
//       {/* Background Elements using theme colors */}
...
//           >
//             {/* Note: Yellow for stars is a universal convention, so it's kept as a direct color. */}
...
//               <div className="relative bg-card/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-border h-full">
//                 <div className="mb-6">
//                   <Quote className="w-10 h-10 text-primary/30 fill-current" />
//                 </div>

//                 <blockquote className="text-secondary-foreground text-lg leading-relaxed mb-8 font-medium">
//                   "{testimonial.quote}"
//                 </blockquote>
...
//                 {/* Highlight Badge using success theme color */}
//                 <div className="mb-6">
...
//                       }}
//                     />
//                     {/* Status Indicator using success theme color */}
...
//         {/* Bottom Stats using theme colors */}
//         <motion.div 
...
//               transition={{ type: "spring", stiffness: 300 }}
//             >
//               <div className="text-2xl font-bold bg-gradient-to-r from-primary to-secondary-foreground bg-clip-text text-transparent mb-2">
//                 50,000+
//               </div>
...
//               transition={{ type: "spring", stiffness: 300 }}
//             >
//               <div className="text-2xl font-bold bg-gradient-to-r from-success to-green-600 bg-clip-text text-transparent mb-2">
//                 4.9/5
//               </div>
...
//               transition={{ type: "spring", stiffness: 300 }}
//             >
//               <div className="text-2xl font-bold bg-gradient-to-r from-accent-purple to-accent-pink bg-clip-text text-transparent mb-2">
//                 95%
//               </div>
...
//               transition={{ type: "spring", stiffness: 300 }}
//             >
//               <div className="text-2xl font-bold bg-gradient-to-r from-orange-500 to-destructive bg-clip-text text-transparent mb-2">
//                 2M+
//               </div>
