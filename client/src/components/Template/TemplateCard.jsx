...
//   return (
//     // The main Dialog for preset selection, which wraps the entire component logic
//     <Dialog open={isPresetDialogOpen} onOpenChange={setIsPresetDialogOpen}>
//       <motion.div layout className="w-full">
//         {/* The visual container for the image and the preview button */}
//         <div className="relative group">
//           {/* The image itself is the trigger for the main dialog */}
...
//           {/* The Preview functionality is a separate, self-contained Dialog */}
//           <Dialog>
//             <DialogTrigger asChild>
//               <Button
//                 variant="secondary"
...
//                 // This is critical: it prevents a click on Preview from also opening the main dialog
...
//         {/* The template name is now a separate element below the image container */}
//         <div className="text-center pt-3">
//           <h3 className="text-base font-semibold text-foreground">{templateName}</h3>
//         </div>
//       </motion.div>
      
//       {/* This is the content for the main Dialog, triggered by clicking the image */}
